            ...
            <div className="relative h-screen px-4 py-32 overflow-hidden">
               ...
               <motion.div
                 style={{ 
                   ...
                   y: useTransform(scrollYProgress, [0.4, 0.5], [50, 0])
                 }}
                 className="absolute inset-0 flex items-center justify-start px-4 text-white/20 pointer-events-none"
               >
